...
We asked to some to \todo[inline]{act as the automatic text generator, filling}act as the automatic text generator, filling out a form in an Excel file, where the users were given twenty random prompts, similar to the ones that are given to the GPT model. \\
